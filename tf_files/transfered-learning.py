...
#print url
url = 'DRONECAM-ACT3-SCENE2-RUN1.mp4'


# Science Thresholds
person_threshold = 0.75
person_gun_threshold = 0.20
...
videoName = url + '-EDITED-output.avi'
...
#                     line_thickness=8)
    ...
    ##################### Perform Assalt Rifle Recognition #######################
            ...
            for person in range(0,len(df6.index)):
...
#                         red = 255
                    ...
                    threshold =  0.93
                    person_color_threshold = 0.95
                    #frame_person_Score = int(df6.iloc[person]['scores'])
                    print ps[person] , score



                    if (score >= threshold) and (ps[person] > person_color_threshold)  :

                        red = 0
                        #red = 0 * ((score / threshold ) - 1)
                        green = 255
                        line = 10
                    ...
                    cv2.rectangle(image_np, (px[person],py[person]), (px[person]+wid[person], py[person]+ hei[person]), (0, green, red), line)
